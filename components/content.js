...
import {ComponentAbout} from './tab-about.js'
import {ComponentContacts} from './tab-contacts.js'
import {ComponentReviews} from './tab-reviews.js'
                        ...
                        <div class="col-5 col-md-3 col-lg-3 px-1 my-md-1 mb-1 mb-md-0">
                            <fieldset class="form-group d-flex align-items-center justify-content-center flex-column">
                                ...
                                <select v-model="selectedCountry" id="countrys" class="form-control cursor" @click="selectCountry()">
                                    ...
                                    <option v-for="array in filterCountrys"  :key="array.country" :value="array.country">{{ array.country }}</option>
                                </select>
                            </fieldset>
                        </div>
